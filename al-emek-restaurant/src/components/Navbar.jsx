...
export default function Navbar({ activePage, setActivePage }) {
  ...
  return (
    ...
    >
      ...
      {/* 1. TOP BAR: Logo + Social Links + Language Switcher */}
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2.5 flex items-center justify-between border-b border-white/5 gap-2">
        ...
        >
          ...
          <span className="text-sm sm:text-2xl font-black bg-gradient-to-r from-[#F3E5AB] via-[#D4AF37] to-[#AA771C] bg-clip-text text-transparent tracking-wide drop-shadow-sm">
            {lang === 'ar' ? 'مطعم العيمق' : lang === 'en' ? 'Al-Emek' : 'מסעדת העמק'}
          </span>
        </div>

        {/* Right Section: Social Icons + Language Switcher */}
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <a
              ...
              aria-label="TikTok"
              className="w-7 h-7 sm:w-8 sm:h-8 bg-[#181818] hover:bg-[#00F2FE] hover:text-black text-gray-300 rounded-full border border-[#D4AF37]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-sm"
            >
            ...
            <a
              ...
              className="w-7 h-7 sm:w-8 sm:h-8 bg-[#181818] hover:bg-gradient-to-tr hover:from-amber-500 hover:via-rose-500 hover:to-purple-600 hover:text-white text-gray-300 rounded-full border border-[#D4AF37]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-sm"
            >
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-current" viewBox="0 0 24 24">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="w-7 h-7 sm:w-8 sm:h-8 bg-[#181818] hover:bg-[#1877F2] hover:text-white text-gray-300 rounded-full border border-[#D4AF37]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-sm"
            >
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-current" viewBox="0 0 24 24">
            ...
            {['he', 'ar', 'en'].map((l) => {
              ...
              return (
                <button
                  key={l}
                  onClick={() => setLang(l)}
                  className={`px-2 sm:px-2.5 py-0.5 sm:py-1 text-[10px] sm:text-xs font-black rounded-full uppercase tracking-wider transition-all duration-300 ${
                    isActive 
      ...
      {/* 2. NAVIGATION BAR: All 5 Titles Visible Directly On Mobile */}
