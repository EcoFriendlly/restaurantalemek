...
export default function Navbar({ activePage, setActivePage }) {
  ...
  // Full native language names display configuration
  const languages = [
    { code: 'he', label: 'עברית' },
    { code: 'ar', label: 'عربية' },
  ...
  return (
    ...
    >
      ...
      {/* 1. TOP BAR: Logo + Social Links + Full Language Switcher */}
      <div className="max-w-7xl mx-auto px-2.5 sm:px-6 py-2.5 flex items-center justify-between border-b border-white/5 gap-2">
        ...
        {/* Right Section: Social Icons + Full Language Switcher */}
        <div className="flex items-center gap-1.5 sm:gap-4 shrink-0">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <a
              ...
              aria-label="TikTok"
              className="w-6 h-6 sm:w-8 sm:h-8 bg-[#181818] hover:bg-[#00F2FE] hover:text-black text-gray-300 rounded-full border border-[#D4AF37]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-sm"
            >
            ...
            <a
              ...
              className="w-6 h-6 sm:w-8 sm:h-8 bg-[#181818] hover:bg-gradient-to-tr hover:from-amber-500 hover:via-rose-500 hover:to-purple-600 hover:text-white text-gray-300 rounded-full border border-[#D4AF37]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-sm"
            >
              <svg className="w-3 h-3 sm:w-4 sm:h-4 fill-current" viewBox="0 0 24 24">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="w-6 h-6 sm:w-8 sm:h-8 bg-[#181818] hover:bg-[#1877F2] hover:text-white text-gray-300 rounded-full border border-[#D4AF37]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-sm"
            >
              <svg className="w-3 h-3 sm:w-4 sm:h-4 fill-current" viewBox="0 0 24 24">
          ...
          {/* Premium Pill Language Switcher with Full Text */}
          <div className="flex bg-[#161616] p-0.5 sm:p-1 rounded-full border border-[#D4AF37]/30 shadow-inner gap-0.5" dir="ltr">
            {languages.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`px-1.5 sm:px-2.5 py-0.5 sm:py-1 text-[9px] sm:text-xs font-black rounded-full transition-all duration-300 whitespace-nowrap ${
                    isActive 
      ...
      {/* 2. NAVIGATION BAR: All 5 Titles Directly Visible */}
